...
#
# Script generated by Vivado on Thu May 07 15:37:26 KST 2026
...
copy_setup_file()
{
  file="modelsim.ini"
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/khwl/Downloads/smu-piveline-develop/FPGA/Piveline.cache/compile_simlib/modelsim"
  fi
